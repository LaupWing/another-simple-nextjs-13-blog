      ...
      <section className="custom-container min-h-screen py-20">
         ...
         <div className="mt-4">
            ...
            <article className="prose dark:prose-invert">
               ...
               <p>
                  As coding became second nature, I decided to broaden my skills. I enrolled in a university program focused on web design called <CustomLink href="https://www.hva.nl/opleidingen/communication-and-multimedia-design">Communication Multimedia Design</CustomLink>. Here, I not only delved deeper into coding but also recognized the significance of soft skills like communication, time management, and teamwork. I continue to refine these skills daily, understanding their crucial role in a developer's success.
               </p>
               <p>
                  With 5 years of experience as a web developer post-graduation, I've worked with various technologies. My expertise lies in <CustomLink href="https://vuejs.org/">Vue.js</CustomLink>, <CustomLink href="https://nextjs.org/">React/Next.js</CustomLink>,  <CustomLink href="https://nodejs.org/en">Node.js</CustomLink>, and <CustomLink href="https://laravel.com/">PHP/Laravel</CustomLink>, primarily focusing on frontend frameworks. While my proficiency in backend frameworks like Node.js and especially Laravel spans 2 years, I've dedicated each day within that timeframe to backend programming. I'm also keen on expanding my knowledge in DevOps and cloud technologies.
               </p>
               <p>
