...
const fetchProject = async (slug: string, lang: Locale) => {
    const post = await getFileBySlug("projects", slug, lang)
...
export async function generateMetadata(props: PageProps): Promise<Metadata> {
    const post = await fetchProject(props.params.slug, props.params.lang)
...
const SingleProjectPage = async (props: PageProps) => {
    const { frontmatter, code } = await fetchProject(
        props.params.slug,
        props.params.lang,
    )
