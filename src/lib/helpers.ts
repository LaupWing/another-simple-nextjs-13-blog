...
export const openGraph = ({
   ...
   return `${process.env.SITE_URL}/api/og/gradient?siteName=${og_sitename}&description=${og_description}&logo=${og_logo}${og_template_title ? `&templateTitle=${og_template_title}` : ""}`
}
